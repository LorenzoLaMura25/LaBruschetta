...
const Prenota = () => {
  return (
    <div id="main-container">
      <div id="background-diagonal"></div>

      <div id="prenotazione-header">
        <h1 id="prenotazione-title">Prenota il tuo tavolo</h1>
        <p id="prenotazione-subtitle">
      ...
      <div id="content-container">
        <div id="shadow-box">
          <div id="box-prenotazione">
            <FormPrenotazione />
          </div>

          <div id="box-posizione-contatti">
            <div id="posizione">
              <h2 id="posizione-title">Posizione & Orari</h2>
              <iframe
                title="Location"
                ...
                loading="lazy"
              ></iframe>
              <h1 id="orari">Orario Continuato</h1>
              <p id="orari">Aperto tutti i giorni (11:00 - 23:30)</p>
            </div>
            <hr />
            <div id="contatti">
