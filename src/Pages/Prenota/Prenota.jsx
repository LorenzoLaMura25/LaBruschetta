  ...
  return (
    <div className="main-container">
      ...
      <div className="prenotazione-header">
        <h1 className="prenotazione-title">Prenota il tuo tavolo</h1>
        ...
        <div className="shadow-box">
          ...
          <div className="box-posizione-contatti">
            <div className="posizione">
              <h2 className="posizione-title">Posizione & Orari</h2>
              <iframe
                title="Location"
                ...
                loading="lazy"
              ></iframe>
              <h1 className="orari">Orario Continuato</h1>
              <p className="orari">Aperto tutti i giorni (11:00 - 23:30)</p>
            </div>
            <hr />
