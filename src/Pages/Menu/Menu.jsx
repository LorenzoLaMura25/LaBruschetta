...
const menuCategories = {
  Ristorante: {
    ...
    "La Nostra Pasta all' uovo Tirata a Mano": [
      ...
      {
        name: "Tonnarelli Acqua e Farina alla Carbonara con Pepe Rosa",
        price: "€14.50",
      },
    ...
    "Le carni": [
      ...
      {
        name: "Abbacchio Arrosto al Forno a Legna con Patate",
        price: "€22.00",
      },
      {
        name: "Stinco di Vitella al Forno a Legna con purea di Patate",
        price: "€21.00",
      },
    ...
    "I Nostri Dolci Artigianali": [
      ...
      {
        name: "Crema al Limone con Savoiardi al Limoncello e Meringa Morbida",
        price: "€7.60",
      },
  ...
  Cantina: {
    ...
    "Calici di Vino": [
      ...
      {
        name: "Sauvignon - Pinot Grigio - Chardonnay - Falanghina - Rosè ",
        price: "€7.50",
      },
      { name: "Prosecco - Gewurztraminer", price: "€8.50" },
      {
        name: "Merlot - Chianti - Cannonau - Sangiovese - Dolcetto D'Alba",
        price: "€8.50",
      },
